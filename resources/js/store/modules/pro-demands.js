...
export default {
    ...
    actions: {
        ...
        //     await axios.get(`/api/pro/demands/get/all`).then(async response => {
        ...
        initReportedDemands: async function({commit}){
            await axios.get(`/api/pro/reported/demands/get/all`).then(async response => {
                // console.log('preluam reported demands pentru PRO', response.data);
                if(response.data.demands){
                    let demands = Object.values(response.data.demands);
        ...
        initUnlockedDemands: async function({commit}){
            await axios.get(`/api/pro/demands/get/unlocked/all`).then(async response => {
