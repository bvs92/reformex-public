...
<div class="">
        ...
        >
            ...
            <template #cell(actions)="row">
                <a class="btn btn-sm btn-info" :href="'/categorii/detalii/' + row.item.slug">
                Vezi
                </a>
            </template>
...
export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'total_demands', sortable: true, label: 'Număr cereri' },
    ...
    computed: {
        ...mapGetters('categories', ['getCategories', 'getTotalCategories']),
        ...
        getSortBy: function(){
            if(this.sortBy == 'name'){
                return 'Nume';
            } else if(this.sortBy == 'total_demands'){
                return 'Număr cereri';
            }
        }
    },
