...
<div class="cbp_tmlabel empty" v-if="demand">
    <div class="py-2">
        <h2 v-if="owner"><a href="javascript:void(0);" class="font-weight-bold">{{ owner.complete_name }}</a><span>, ati lansat cererea de mai jos.</span></h2>
    </div> 
    <ul class="demo-accordion accordionjs m-0" data-active-index="false">
        <!-- SECTION 1 -->
        <li>
            <div><h3>Afisati detalii complete despre cerere #{{ demand.uuid }}.</h3></div>
            <div>
                <div class="row justify-content-center p-4">
                    <div class="col-md-12 py-4" style="background: white;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <p class="py-2" v-if="owner"><i class="fa fa-user"></i> {{ owner.complete_name }}</p>
                        ...
                        <!-- <div id="mapid"></div> -->
                        <map-demand-component :accessTokenMap="accessTokenMap" :lat="demand.lat" :lng="demand.lng"></map-demand-component>
