<template>
  <div>
        ...
        <div class="overflow-auto" v-if="getTotalPersonalCoupons > perPage">
            <div class="mt-3">
                <b-pagination 
                v-model="currentPage" 
                pills 
                :total-rows="getTotalPersonalCoupons" 
                :per-page="perPage"
...
export default {
    name: "ListPersonalCouponsComponent",
    ...
    computed: {
        ...mapGetters('coupons', ['getPersonalCoupons', 'getTotalPersonalCoupons']),

        getTheCoupons: function(){
            return this.getPersonalCoupons.map(item => {
    ...
    methods: {
        ...
        goToPage: function(_item){
            ...
            window.location = '/cupoane/detalii/' + _item.item.uuid;
        },
    ...
    created: function(){
        ...
        this.$store.dispatch('coupons/initPersonalCoupons').finally(() => {
            this.isBusy = false;
        });
    }
