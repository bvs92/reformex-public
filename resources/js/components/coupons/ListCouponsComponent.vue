<template>
  <div>
        ...
        <div class="overflow-auto" v-if="getTotalCoupons > perPage">
            <div class="mt-3">
                <b-pagination 
                v-model="currentPage" 
                pills 
                :total-rows="getTotalCoupons" 
                :per-page="perPage"
...
export default {
    ...
    computed: {
        ...mapGetters('coupons', ['getCoupons', 'getTotalCoupons']),

        getTheCoupons: function(){
            return this.getCoupons.map(item => {
    ...
    methods: {
        ...
        goToPage: function(_item){
            ...
            window.location = '/cupoane/' + _item.item.uuid;
        },
    ...
    created: function(){
        ...
        this.$store.dispatch('coupons/initCoupons').finally(() => {
            this.isBusy = false;
        });
    }
