...
export default {
    ...
    methods: {
        ...
        updateOptions: async function(){
            ...
            await axios.post('/api/ads_recommend/update_announce_options/' + this.ad.id, formData)
            .then(async response => {
        ...
        updatePeriod: async function(){
            ...
            await axios.post('/api/ads_recommend/update_announce_period/' + this.ad.id, formData)
            .then(async response => {
        ...
        updateCategories: async function(){
            ...
            await axios.post('/api/ads_recommend/update_announce_categories/' + this.ad.id, formData)
            .then(async response => {
                console.log(response.data);
                if(response.data.success){
                    // adauga user in lista.
