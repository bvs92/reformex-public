                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="d-flex justify-content-center">
                            <button class="btn btn-sm btn-default" @click="deleteSelected">Elimină imagine</button>
                        </div>
                    </div>
                </div><!-- end row -->
...
export default {
    ...
    methods: {
        ...
        onSubmit: async function(){
            ...
            await axios.post('/api/banners/store', formData, config).then(async response => {
