<template>
<div>
    <div class="row justify-content-center" v-if="getBanner.paid == 0">
        <div class="card col-lg-8">
            ...
            <div class="card-body">
                <p>Pentru a activa anunțul este necesar efectuarea plății.</p>
                <br>
                <a :href="`/publicitate/banner/detalii/${uuid}/activare`" class="btn btn-primary">Activare anunț</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 my-3">
            <div class="d-flex justify-content-end" v-if="getBanner.rejected == 0">
...
export default {
    ...
    methods: {
        ...
        updateAnnounce: async function(){
            ...
            await axios.post('/api/banners/personal/update_announce/' + this.getBanner.id, formData).then(async response => {
        ...
        deleteBanner: async function(){
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    await axios.delete('/api/banners/personal/delete/' + this.uuid)
                        .then(async response => {
                            if(response.data.success){
                                Vue.$toast.open({
                                ...
                                location.replace('/publicitate/banner')
