<template>
    ...
    <div class="row" v-else>
        ...
        <div class="col-lg-12 my-4" v-if="getBanner">
            <h4 class="text-center mb-3">Categoriile anunțului</h4>
            <div class="d-flex justify-content-center">
                <span v-for="category in getBanner.categories" :key="category.id" class="badge badge-info big mx-2" >
                {{ category.name }}
                </span>
            </div>
        </div>
        ...
        <div class="jumbotron col-lg-12">
            <div class="container row">
                ...
                <div class="col-lg-12 my-4" v-if="selected && isVisible">
                    <form :action="`/plata/banner/checkout/${uuid}/${selected.id}`" method="POST">
...
export default {
    ...
    computed: {
      ...
      ...mapGetters('banner_payment', ['getCost']),
    ...
    methods: {
      ...
      loadPeriods: async function(){
        ...
        calculateCost: async function(){
            ...
            await this.$store.dispatch('banner_payment/calculateCost', payload).finally(() => {
        ...
        loadBanner: async function(){
            ...
            await this.$store.dispatch('banners/getSingle', this.uuid).finally(() => {
