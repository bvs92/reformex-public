    ...
    <div class="card border-dark mb-3">
        ...
        <div class="card border-dark mb-3">
            <div class="card-header">Categorii</div>
                ...
                <template v-if="banner.rejected == 0">
...
export default {
    ...
    methods: {
        ...
        updateOptions: async function(){
            ...
            await axios.post('/api/banners/personal/update_announce_options/' + this.banner.id, formData)
            .then(async response => {
        ...
        updateCategories: async function(){
            ...
            await axios.post('/api/banners/personal/update_announce_categories/' + this.banner.id, formData)
            .then(async response => {
                console.log(response.data);
                if(response.data.success){
                    // adauga user in lista.
