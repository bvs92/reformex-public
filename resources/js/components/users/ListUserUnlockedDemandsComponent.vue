...
export default {
    name: "ListUserUnlockedDemandsComponent",
    ...
    computed: {
        ...mapGetters('users', ['getUnlockedDemands', 'getTotalUnlockedDemands']),
    ...
    created: function(){
        ...
        this.$store.dispatch('users/initUnlockedDemands', this.the_user_id).finally(() => {
            this.isBusy = false;
        });
    }
