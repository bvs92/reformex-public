<template>
<div>
  <button @click.prevent="editModal" class="btn btn-sm btn-warning mx-2 float-right">Modifica</button>

  <b-modal v-model="modalShow" hide-footer id="modal-center" centered title="ADMIN - Editare proiect">
      <ValidationObserver ref="observer" v-slot="{ handleSubmit, invalid }">
                <form class="row" @submit.prevent="handleSubmit(onSubmit)">
                    ...
                    <div class="col-lg-12 my-2">
                        <validation-provider rules="required" v-slot="{ errors, invalid, passed, touched }">
                            <label for="description">Titlu</label>
                    ...
                    <div class="col-lg-12 my-2">
                        <button class="btn btn-success" :class="{'disabled': invalid}" :disabled="invalid" v-if="!btnLoading">Salveaza</button>
...
export default {
    ...
    methods: {
        ...
        onSubmit: function(){
            ...
            axios.post(`/api/admin/work-projects/update/${this.project.uuid}`, formData).then(response => {
