  ...
  <div>
    <validation-provider rules="required" v-slot="{ errors, invalid, passed, touched }">
        ...
        >
            ...
            <span slot="maxElements">Numărul maxim de categorii a fost atins.</span>
            <span slot="afterList" class="text-muted p-2"><small>Selectează una sau mai multe categorii.</small></span>
