...
export default {
    name: "ProListReportedDemandsComponent",
    ...
    computed: {
        ...mapGetters('pro_demands', ['getReportedDemands', 'getTotalReportedDemands']),
    ...
    created: function(){
        ...
        this.$store.dispatch('pro_demands/initReportedDemands').finally(() => {
            this.isBusy = false;
        });
    }
