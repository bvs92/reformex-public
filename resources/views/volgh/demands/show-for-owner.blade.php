                ...
                <div class="card">
                        ...
                        <div class="card-options">
                            ...
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a onclick="event.preventDefault();document.getElementById('deleteDemandAndConversations').submit();" class="dropdown-item"><i class="ti-trash"></i> Elimina cerere & conversatii (owner)</a>
                                   
                                    <form 
                                        action="{{ route('demands.destroy.owner.conversations', $demand->id) }}" 
                                        id="deleteDemandAndConversations" 
                                        method="POST" 
                                        style="display: none;">
                                        @csrf
                                        <input type="hidden" name="_method" value="DELETE">
                    ...
                    <div class="card-body">
                        <div class="grid-margin">
                            <div class="">
                                <div class="row justify-content-center p-4">
                                    <div class="col-md-8 p-4" style="background: white;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                {{-- <p>Distanta aproximativa: <span id="distance"></span></p> --}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 p-4">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">Alte detalii cerere</h3>
                                                <div class="card-options">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($demand->hasActiveWinner())
                                                    <div class="row my-4">
                                                        <div class="col-lg-4">
                                                            @if($demand->getWinner()->professional->user->hasProfilePhoto())
                                                                <img src="{{ asset($demand->getWinner()->professional->user->getFullProfilePhoto()) }}" alt="{{ $demand->getWinner()->professional->getName() }}" class="avatar avatar-md rounded-circle">
                                                            @else
                                                                <img src="{{URL::asset('assets/images/users/10.jpg')}}" alt="{{ $demand->getWinner()->professional->getName() }}" class="avatar avatar-md rounded-circle">
                                                            @endif
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <p class="mt-2">
                                                                {{ $demand->getWinner()->professional->getName() }}
                                                            </p>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <span class="badge badge-success mt-2">Castigator</span>
                                                ...
                                                @else
                                                    <div class="row bg-light">
                                                        <div class="col-lg-6">
                                                            <p class="mt-4">Stare cerere: @if($demand->isStateActive()) <span class="badge badge-success">Activa</span> @else <span class="badge badge-default">Inactiva</span> @endif</p>
                                                        </div>
                                                        <div class="col-lg-6">
                                                                @if($demand->hasUUID())
                                                                <a onclick="event.preventDefault();document.getElementById('changeState').submit();" class="btn btn-sm btn-blue mt-4 text-white d-flex justify-content-center"><i class="ti-reload"></i> Schimba stare</a>
                            ...
                            @if($demand->professionals && $demand->professionals->count() > 0)
                            <!-- ROW-3 OPEN -->
                            <h3>Firme participante</h3>
                            <div class="row">
                                @foreach($demand->professionals as $professional)
                                <div class="col-md-4 col-xl-4">
                                    <div class="card ">
                                        <div class="card-header ">
                                            <h3 class="card-title ">
                                                {{ $professional->getName() }} @if($demand->hasActiveWinner()) @if($demand->getWinner()->professional_id == $professional->id)
                                                <span class="badge badge-success mr-1 mb-1 mt-1">Castigator</span>
                                                @endif @endif
                                            </h3>
                                            <div class="card-options">
                                                <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
                                        ...
                                        <div class="card-body text-center">
                                            @if($professional->user->hasProfilePhoto())
                                                <span class="avatar avatar-xxl brround cover-image cover-image" data-image-src="{{ asset($professional->user->getFullProfilePhoto()) }}"></span>
                                            @else
                                                <span class="avatar avatar-xxl brround cover-image cover-image" data-image-src="{{URL::asset('assets/images/users/10.jpg')}}"></span>
                                            @endif
                                            ...
                                            <p class="card-text">
                                                ...
                                                <br>
                                                @if($demand->hasActiveWinner())
                                                    @if($demand->getWinner()->professional_id == $professional->id)
                                                    <span class="badge badge-success mr-1 mb-1 mt-1">Castigator cerere!</span>
                                                    @endif
                                                @elseif($demand->hasProspect($professional->id)) 
                                                    {{-- @if($demand->prospect->professional_id == $professional->id) --}}
                                                        <span class="badge badge-info mr-1 mb-1 mt-1">I-ati propus o intelegere!</span>
                                                    {{-- @endif --}}
                                                @endif
                                            </p>

                                            @foreach($demand->timelines as $timeline)
                                                @if($timeline->professional_id == $professional->id)
                                                    @if(!$demand->hasActiveWinner())
                                                        @if(!$demand->hasProspect($professional->id))
                                                            <hr>
                                                            <a onclick="event.preventDefault();document.getElementById('winnerDemand-{{ $professional->id }}').submit();" class="btn btn-block btn-success text-white"><i class="ti ti-heart"></i> Propune intelegere</a>
                                                            <form 
                                                                action="{{ route('demands.prospect', ['demand_id' => $demand->id, 'professional_id' => $professional->id, 'timeline_id' => $timeline->id]) }}" 
                                                                id="winnerDemand-{{ $professional->id }}" 
                                                                method="POST" 
                                                                style="display: none;">
                                                                @csrf
                                                                @method('PUT')
                                            ...
                                            <div class="row user-social-detail">
                                                <div class="col-lg-6 col-sm-6 col-6">
                                                    @foreach($demand->timelines as $timeline)
                                                        @if($timeline->professional_id == $professional->id)
                                                            @if($timeline->hasUUID())
                                                                <a href="{{ route('timeline.show.client.uuid', $timeline->uuid) }}"><i class="fa fa-eye" aria-hidden="true"></i> Conversatie</a>
                                                            @else
                                                                <a href="{{ route('timeline.show.client', $timeline->id) }}"><i class="fa fa-eye" aria-hidden="true"></i> Conversatie</a>
                                                            @endif
                                                        @endif
                                                    @endforeach
                                                </div>
                                                <div class="col-lg-6 col-sm-6 col-6">
                                                    <a href="{{ route('user.pro.profile', $professional->id) }}"><i class="fa fa-user" aria-hidden="true"></i> Profil</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
