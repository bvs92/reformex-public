                                            ...
                                            <div class="card mt-2" style="border:none;border-bottom:1px solid #f1f1f1;">
                                                <div class="card-header ">
                                                    ...
                                                    <div class="card-options">
                                                        {{-- <a href="{{ route('demands.create') }}" id="add__new__demand" class="btn btn-md btn-primary "><i class="fa fa-plus"></i> Adauga cerere noua</a> --}}
                                                        @if(auth()->user()->isPro())
                                                        <a href="{{ route('demands.show', $demand) }}" class="btn btn-lg btn-warning float-right"><i class="fa fa-eye" aria-hidden="true"></i> Aplica pentru proiect</a>
                                                        @else
                                                        <a href="{{ route('demands.show.not.pro', $demand->uuid) }}" class="btn btn-lg btn-info float-right"><i class="fa fa-eye" aria-hidden="true"></i> Vezi detalii complete</a>
                                                        @endif
                                                    </div>
                                                </div>
