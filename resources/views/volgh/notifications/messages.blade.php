    ...
    <!-- PAGE-HEADER -->
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mesaje</li>
            </ol>
        </div>							
    <!-- PAGE-HEADER END -->
@endsection
                                                ...
                                                @if($notifications && $notifications->count() > 0)
                                                    @foreach($notifications as $notification)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    <a href="{{ route('notifications.show.message', $notification->id) }}" class="btn btn-info btn-sm m-1">Vezi</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
