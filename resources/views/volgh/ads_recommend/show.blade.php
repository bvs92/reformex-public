...
@section('page-header')
    <!-- PAGE-HEADER -->
        <div>
            <h1 class="page-title">Detalii anunț</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Acasă</a></li>
                <li class="breadcrumb-item active" aria-current="page">Detalii anunț</li>
            </ol>
        </div>							
    <!-- PAGE-HEADER END -->
@endsection
                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header ">
                            <h3 class="card-title ">Detalii anunț</h3>
                        </div>
                        <div class="card-body">
                            <div class="grid-margin">
                                ...
                                @endif
                                <show-single-personal-ad-recommend-component :uuid="{{ json_encode($uuid) }}"></show-single-personal-ad-recommend-component>
                            </div>
                        </div>
                    </div>
                </div><!-- COL END -->
