            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="d-flex justify-content-end">
                        <a onclick="event.preventDefault();document.getElementById('deleteByClient').submit();" class="btn btn-danger btn-sm text-white"><i class="ti-trash"></i> Elimina conversatie</a>           
                        <form 
                            action="{{ route('timeline.delete.client', $timeline->id) }}" 
                            id="deleteByClient" 
                            method="POST" 
                            style="display: none;">
                            @csrf
                ...
                <div class="col-md-12">
                    <ul class="cbp_tmtimeline">
                        ...
                        <li>
                            ...
                            <div class="cbp_tmlabel empty">
                                <div class="py-2">
                                    ...
                                    <h4 class="">Ati eliminat cererea aferenta acestei conversatii.</h4>
                                </div> 
                            </div>
                            @endif
                        </li>
                        ...
                        <li>
                            ...
                            <div class="cbp_tmicon bg-success"><i class="ti ti-unlock"></i></div>
                            <div class="cbp_tmlabel empty"> 
                                <h2><a class="font-weight-bold" href="{{ route('user.pro.profile', $professional->user_id) }}" target="_blank">{{ $professional->user->company ? $professional->user->company->name : $professional->getName() }} <i class="ti ti-new-window font-weight-light"></i></a> <span> a interactionat cu cererea dumneavoastra.</span></h2>
                            </div>
                        </li> <!-- end unlocked_demand -->
                        @endif
                                ...
                                <div class="cbp_tmlabel empty"> 
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @else
                                            <h2><span>Raspunsul <a href="{{ route('user.pro.profile', $professional->user_id) }}" class="text-primary font-weight-bold" target="_blank">{{ $professional->getName() }} <i class="ti ti-new-window font-weight-light"></i></a> pentru castigarea cererii curente este in asteptare.</span></h2>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cbp_tmlabel empty"> 
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @else
                                            <h2><a href="{{ route('user.pro.profile', $professional->user_id) }}" class="text-primary font-weight-bold" target="_blank">{{ $professional->getName() }} <i class="ti ti-new-window font-weight-light"></i></a> <span>a acceptat propunerea dumneavoastra. Cererea curenta poate fi castigata de acest profesionist.</h2>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cbp_tmlabel empty"> 
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @else
                                            <h2><span><a href="{{ route('user.pro.profile', $professional->user_id) }}" class="text-primary font-weight-bold" target="_blank">{{ $professional->getName() }} <i class="ti ti-new-window font-weight-light"></i></a> a respins propunerea dumneavoastra pentru cererea curenta. Alegeti un alt profesionist cu care puteti stabili o intelegere. Mult succes!</span></h2></div>
                                            @endif
                                    </div>
                                </div>
                            </li> 
