...
@section('page-header')
    <!-- PAGE-HEADER -->
        <div>
            <h1 class="page-title">Conversatii cu firme</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/home">Acasa</a></li>
                <li class="breadcrumb-item active" aria-current="page">Conversatii cu firme</li>
            </ol>
        </div>							
    <!-- PAGE-HEADER END -->
@endsection
                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header ">
                            <h2 class="card-title ">Lista conversatii ({{ $total_timelines }})</h2>
                            ...
                            <div class="grid-margin">
                                <div class="">
                                    @forelse($timelines as $timeline)   
                                        ...
                                        <div class="card mt-2">
                                            <div class="card-body">
                                                <h3 class="card-title mb-5"><span class="text-muted">Conversatie: </span>Eu <i class="fa fa-exchange text-success"></i> {{ $timeline->professional->getName() }} <i class="fa fa-long-arrow-right"></i> <span class="text-muted">(Numar cerere #{{ $timeline->demand->getDisponibleId() }})</span></h3>
                                                {{-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> --}}
                                            
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        <p>ID: <strong>{{ $timeline->getDisponibleId() }}</strong> </p>
                                                        <p>Subiect: <strong>{{ $timeline->demand->subject }}</strong> </p>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        {{-- <p>Demarare proiect: <span class="text-success"></span></p> --}}
                                                        <p>Conversatie creata: <i class="fa fa-clock-o" aria-hidden="true"></i> {{ formatCarbonDate($timeline->created_at) }}</p>
                                                        @if($timeline->hasUUID())
                                                        <a href="{{ route('timeline.show.client.uuid', $timeline->uuid) }}" class="btn btn-sm btn-primary">Vezi conversatie</a>
                                                        @else
                                                        <a href="{{ route('timeline.show.client', $timeline->id) }}" class="btn btn-sm btn-primary">Vezi conversatie</a>
                                                        @endif
