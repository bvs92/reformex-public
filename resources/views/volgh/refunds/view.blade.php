    ...
    <!-- PAGE-HEADER -->
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('refundsdemands.index') }}">Cereri de restituire</a></li>
            ...
            <div class="col-12 col-sm-12">
                <div class="card">
                    <div class="card-header ">
                        <h2 class="card-title ">Numar ordine plata: #{{ $demand->payment_intent_id }}</h2>
                        ...
                        <div class="grid-margin">
                                ...
                                <div class="row justify-content-center p-4">
                                    <div class="col-md-6 p-4" style="background: white;">
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-lg-6">
                                                <p><i class="side-menu__icon fa fa-user"></i> {{ $demand->user->getname()}}</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 p-4">
                                        <ul class="list-group my-2">
                                            ...
                                            @if($customer->profile->phone)
                                                <li class="list-group-item">Telefon: {{ $customer->profile->phone }}</li>
                                            @endif
                                        </ul>
                                        ...
                                        <div class="row">
                                            ...
                                            @role('admin')
                                            @if($payment->amount <= $customer->getCreditAmount())
                                            <div class="col d-flex justify-content-center">
                                                <div class="dropdown float-right">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        <a onclick="event.preventDefault();document.getElementById('markApprove').submit();" class="dropdown-item"><i class="ti-check"></i> Marcare ca 'Aprobat'</a>
                                                        <a onclick="event.preventDefault();document.getElementById('markDeny').submit();" class="dropdown-item"><i class="ti-na"></i> Marcare ca 'Respins'</a>
                                                        {{-- <a onclick="event.preventDefault();document.getElementById('deleteDemand').submit();" class="dropdown-item"><i class="ti-trash"></i> Elimina</a> --}}
                                                    
                                                        <form 
                                                            action="{{ route('refundsdemands.mark.approve', $demand->id) }}" 
                                                            id="markApprove" 
                                                            method="POST" 
                                                            style="display: none;">
                                                            @csrf
                                                        ...
                                                        <form 
                                                            action="{{ route('refundsdemands.mark.deny', $demand->id) }}" 
                                                            id="markDeny" 
                                                            method="POST" 
                                                            style="display: none;">
                                                            @csrf
                            ...
                            <div class="row mt-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <ul class="list-group">
                                        <li class="listunorder1" style="height:45px;">
                                            Tichet asociat: #{{ $demand->ticket->id }}, Status:  
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <ul class="list-group">
                                        @if($payment->charges && $payment->charges->total_count > 0)
                                        @foreach($payment->charges as $charge)
                                            <li class="listunorder1" data-toggle="tooltip" data-placement="top" title="ID: {{ $charge->id }}" style="height:45px;">
                                        ...
                                        @endforeach
                                        @else
                                        <li class="listunorder1">Nu exista detalii despre plata.</li>
                                        @endif
                                    </ul>
                                </div>
                            </div><!-- end row ticket -->
                            ...
                            <div class="row mt-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <h5 class="mt-5">Detalii cerere curenta</h5>
                                    <ul class="list-group">
                                        @foreach($refunds_demands as $refund_demand)
                                            <li class="listunorder1">Cerere rambursare numar #{{ $refund_demand->id }}: 
                                                @if($refund_demand->status == '0')
                                                    <span class="badge badge-warning float-right">In curs</span>
                                                @elseif($refund_demand->status == '1')
                                                    <span class="badge badge-success float-right">Acceptat</span>
                                                @else
                                                    <span class="badge badge-danger float-right">Respins</span>
                                                @endif
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <h5 class="mt-5">Rambursari efectuate</h5>
                                    <ul class="list-group">
                            ...
                            <div class="row mt-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @if($refunds_demands && $refunds_demands->count() > 0)
                                    <h5 class="mt-5">Cereri de rambursare</h5>
                                    <ul class="list-group">
                                        @foreach($refunds_demands as $refund_demand)
                                            <li class="listunorder1">Cerere rambursare numar #{{ $refund_demand->id }}: 
                                                @if($refund_demand->status == '0')
