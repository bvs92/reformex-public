    ...
    <!-- PAGE-HEADER -->
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('work-projects-categories.index') }}">Categorii Proiecte</a></li>
                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header ">
                            <h3 class="card-title ">Adauga o noua categorie</h3>
                        </div>
                        <div class="card-body">
                            <div class="grid-margin">
                                <div class="">
                                    <div>
                                        <form action="{{ route('work-projects-categories.store') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" 
                                                        class="form-control @error('slug') has-error @enderror" 
                                                        id="slug" 
                                                        placeholder="URL categorie" 
