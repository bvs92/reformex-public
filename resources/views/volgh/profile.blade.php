												...
												<div class="col-lg-6 col-md-12">
													<div class="wideget-user-desc d-sm-flex">
														...
														<div class="user-wrap">
															...
															<h6 class="text-muted mb-3">Inregistrat la data: {{ auth()->user()->created_at }}</h6>
													...
													<div class="wideget-user-info">
														...
														@if(auth()->user()->isPro())
															...
															<div class="wideget-user-rating">
																@for($i = 1; $i <= 5; $i++)
																	@if($i <= auth()->user()->getRating())
																		<a href="#"><i class="fa fa-star text-warning"></i></a>
																	@else
																		<a href="#"><i class="fa fa-star-o text-warning mr-1"></i></a> 
																	@endif
																@endfor
																<span>{{ auth()->user()->getRating() }} din 5 stele ({{ auth()->user()->reviews->count() }} @if(auth()->user()->reviews->count() == 1) Recenzie @else Recenzii @endif)</span>
															</div>
															@endif
														@endif
