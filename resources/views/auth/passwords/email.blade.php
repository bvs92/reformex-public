									...
									<div class="card-body p-6">
                                        <h3 class="text-center card-title">Ai uitat parola?</h3>
                                            ...
                                            <div class="wrap-input100 validate-input">
                                                <input id="email" type="email" class="input100 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Adresă de e-mail">
										...
										@if(session('status'))
                                        <div class="text-center text-muted mt-3 ">
                                            Vei primi un e-mail cu detaliile de resetare a parolei. Verifică casuța de e-mail (Inbox si Spam).
                                        </div>
										@endif
