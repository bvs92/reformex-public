...
class SendDirectDemandToCompanyNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->greeting('Salutare, profesionistule!')
            ->greeting($this->details['name'] . ' ți-a trimis o cerere directă prin REFORMEX.')
