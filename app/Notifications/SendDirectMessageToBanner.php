...
class SendDirectMessageToBanner extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->greeting('Salutare!')
            ->greeting($this->details['name'] . ' ți-a trimis un mesaj prin formularul atașat banner-ului.')
